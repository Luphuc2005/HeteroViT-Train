...
# CPU baseline: 18 cores on single GPU node (disabling GPU)
...
echo "=========================================================="
echo "Starting CPU-only benchmark: 18 Cores"
echo "Affinity mask: taskset -c 0-17"
echo "CUDA_VISIBLE_DEVICES: '$CUDA_VISIBLE_DEVICES'"
echo "=========================================================="

taskset -c 0-17 python train.py --config configs/cpu/cpu_18cores.yaml

...
# GPU benchmark (20 epochs, batch_size=256) constrained to 6 physical CPU cores
...
echo "=========================================================="
echo "Starting GPU benchmark: 1 GPU | 6 CPU Cores | Batch Size: 256 | Epochs: 20"
...
taskset -c 0-5 python train.py --config configs/gpu/gpu_cpu6_b256_20e.yaml
